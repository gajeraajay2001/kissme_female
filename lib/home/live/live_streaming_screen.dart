...
class _LiveStreamingScreenState extends State<LiveStreamingScreen>
  ...
  void initState() {
    ...
    context.read<CallsProvider>().setStreamingOn(false);
  ...
  Future<void> initializeAgora() async {
    ...
    _engine.setEventHandler(RtcEngineEventHandler(
      joinChannelSuccess: (channel, uid, elapsed) {
        if (mounted) {
          context.read<CallsProvider>().setStreamingOn(true);
          setState(() {
  ...
  setupCallObserver() async {
    print("AgoraCall setupCallObserver called");
    bool callRefused = context.watch<CallsProvider>().isCallReceived;
    ...
    if (callRefused == true) {
      ...
      if (mounted) {
        ...
        // QuickHelp.goToNavigatorScreen(
        //     context, HomeScreen(currentUser: widget.currentUser!),
        //     route: HomeScreen.route,finish: true,back: true,fromCalling: true);
        // _engine.stopPreview();
        //
        // _engine.leaveChannel();
        // _engine.destroy();
    ...
    return WillPopScope(
      ...
      child: GestureDetector(
        ...
        child: ToolBar(
          ...
          leftButtonWidget: QuickActions.avatarWidget(
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      TextWithTap(
                        widget.mLiveStreamingModel!.getViewers!.length
                            .toString(),
                        color: !QuickHelp.isDarkMode(context)
                            ? kContentColorLightTheme
                            : kContentColorDarkTheme,
  ...
  void saveLiveUpdate() async {
    if (widget.isBroadcaster!) {
      ...
      // QuickHelp.goToNavigatorScreen(
      //     context, HomeScreen(currentUser: widget.currentUser!),
      //     route: HomeScreen.route, back: false);
    }
  }
        ...
        child: Column(
          children: [
            ...
            ContainerCorner(
              ...
              child: Text(
                "Welcome to Kissme Live! Warning: Pornography and other related situation are strictly prohibited during the live broadcast. Once violation the regulation, it will be punished scverely !:",
                style: TextStyle(color: Colors.white),
              ),
            ),
