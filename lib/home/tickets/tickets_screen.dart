                  ...
                  Center(
                    child: Column(
                      children: [
                        sliders(),
                        ticketStep(
                            context, _current, initPremiumSlider().length),
                        getBody(),
  ...
  termsAndPrivacyMobile({Color? color}) {
    return ContainerCorner(
      child: Column(
        children: [
          TextWithTap(
            "in_app_purchases.debit_auth_cancel_any_time".tr(),
            fontSize: 12,
            fontWeight: FontWeight.bold,
            marginBottom: 5,
            marginTop: 10,
          ...
          TextWithTap(
            "in_app_purchases.debit_auth_eula".tr(namedArgs: {
              "store": QuickHelp.isAndroidPlatform()
                  ? "Google Play"
                  : QuickHelp.isIOSPlatform()
                      ? "iTunes"
                      : "Credit card"
