...
class IncomingCallScreen extends StatefulWidget {
  ...
  IncomingCallScreen(
      ...
      this.isVideoCall,
      this.channel,
      this.isFromOtherCall,
      this.currentUser,
      this.agoraRtmRemoteInvitation});
...
class _IncomingCallScreenState extends State<IncomingCallScreen> {
  ...
  void _acceptCall() async {
    ...
    context.read<CallsProvider>().setCallAccepted(true);
  ...
  void _refuseCall() {
    ...
    if (widget.isFromOtherCall == true) {
      QuickHelp.goToNavigatorScreen(
          context,
          HomeScreen(
            currentUser: widget.currentUser,
