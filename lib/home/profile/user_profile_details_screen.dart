...
import '../../models/EncountersModel.dart';
...
import '../chats/responsive_chat.dart';
import '../coins/coins_payment_widget.dart';
import '../encounters/match_screen.dart';
          ...
          children: [
            ...
            Expanded(
              child: ContainerCorner(
                ...
                marginRight: 16,
                onTap: () {
                  checkPermission(true, model: widget.mUser!);
                },
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.center,
                  crossAxisAlignment: CrossAxisAlignment.center,
                  children: [
                    AnimatedBuilder(
                        ...
                        builder: (context, child) {
                          return Icon(
                            Icons.videocam,
                            size: 19 * (animationController!.value + 1.2),
                            color: Colors.white,
                          );
                        }),
                    TextWithTap(
      ...
      Expanded(
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              if (QuickHelp.getPhotosCounter(widget.mUser).length > 0)
                Stack(
                  children: [
                    CarouselSlider.builder(
                        options: CarouselOptions(
                            height: size.height / 2.5,
                            autoPlay: QuickHelp.getPhotosCounter(widget.mUser)
                                        .length >
                                    1
                                ? true
                                : false,
                    ...
                    Align(
                      ...
                      child: Visibility(
                        visible:
                            QuickHelp.getPhotosCounter(widget.mUser).length > 1
                                ? true
                                : false,
              ...
              if (!isNullEmptyOrFalse(widget.mUser!.getPassions) &&
                  widget.mUser!.getPassions![0] != "none") ...[
                Padding(
                  padding: EdgeInsets.only(left: 20, top: 10),
                  child: Text(
                  ...
                  CarouselSlider.builder(
                      ...
                      itemBuilder: (BuildContext context, int itemIndex,
                        ...
                        return ContainerCorner(
                          ...
                          marginRight: 10,
                          child: QuickActions.photosWidget(
                            QuickHelp.getPhotosCounter(widget.mUser)[itemIndex],
                            borderRadius: 8,
                            fit: BoxFit.cover,
                          ),
                        );
