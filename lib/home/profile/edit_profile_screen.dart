                ...
                Flexible(
                  ...
                  child: SingleChildScrollView(
                    child: Padding(
                      ...
                      child: Column(
                        children: [
                          title("edit_profile.about_name".tr(namedArgs: {
                          ...
                          Form(
                            ...
                            child: Column(
                              ...
                              children: [
                                Padding(
                                  ...
                                  child: Container(
                                    ...
                                    child: Padding(
                                      ...
                                      child: TextFormField(
                                        controller:
                                            aboutYouTitleEditingController,
                                        maxLength: 500,
                                        minLines: 1,
                                        maxLines: 100,
                                        autovalidateMode:
                                        ...
                                        validator: (value) {
                                          if (value!.isEmpty) {
                                            return "edit_profile.hint_about_you"
                                                .tr();
                                          } else {
                                            return null;
                                          }
                                ...
                                // GestureDetector(
                                //   onTap: () =>
                                //       _updateCurrentState(currentStepPassions),
        ...
        Container(
          ...
          child: ListView(
            children: [
              ...
              title("edit_profile.about_name".tr(
                  namedArgs: {"name": "${widget.currentUser!.getFirstName}"})),
              Form(
                key: _formKey,
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
              ...
              Padding(
                ...
                child: GestureDetector(
                  onTap: () async {
                    UserModel? result =
                        await QuickHelp.goToNavigatorScreenForResult(context,
                            AddCityScreen(currentUser: widget.currentUser),
                            route: AddCityScreen.route);
        ...
        child: Column(
          children: [
            Wrap(
              ...
              children:
                  List.generate(QuickHelp.getPassionsList().length, (index) {
                ...
                onTap: () {
                  if (currentStep == currentStepPassions) {
                    if (isValidPassions) {
                      ...
                      setState(() {
                        passionsEditingController.text =
                            QuickHelp.getPassionsListWithName(
                                widget.currentUser!);
                      });
    ...
    return Expanded(
      child: ContainerCorner(
        ...
        height: Responsive.isMobile(context)
            ? 180
            : 300, //Responsive.isWebOrDeskTop(context) ? 300 : Responsive.isTablet(context) ? 300 : 145,
        alignment: Alignment.center,
