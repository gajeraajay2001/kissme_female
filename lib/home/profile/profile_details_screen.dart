...
class _ProfileDetailsScreenState extends ResumableState<ProfileDetailsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return ToolBarCenterWidget(
      ...
      iconWidth: 24,
      centerTitle: true,
      centerWidget: TextWithTap("page_title.profile_title".tr(),
                ...
                children: [
                  CarouselSlider.builder(
                      options: CarouselOptions(
                          ...
                          autoPlay:
                              QuickHelp.getPhotosCounter(widget.currentUser)
                                          .length >
                                      1
                                  ? true
                                  : false,
                  ...
                  Align(
                    alignment: Alignment.topCenter,
                    child: Visibility(
                      visible: QuickHelp.getPhotosCounter(widget.currentUser)
                                  .length >
                              1
                          ? true
                          : false,
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Column(
                      children: [
                        info("assets/svg/prof.svg",
                            getWork(widget.currentUser!)),
                        info("assets/svg/school.svg",
                            widget.currentUser!.getSchool!),
                        info(
                            "assets/svg/sex.svg",
                            QuickHelp.getSexualityListWithName(
                                widget.currentUser!)),
                        info("assets/svg/country.svg",
                            widget.currentUser!.getLocation!),
                      ],
                    ),
                  ),
                  Padding(
