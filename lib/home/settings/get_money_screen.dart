...
class _GetMoneyScreenState extends State<GetMoneyScreen> {
  ...
  Widget body() {
    final slider = SleekCircularSlider(
      min: 0,
      max: (widget.currentUser!.getDiamonds!.toDouble()),
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            TextWithTap(
                              "${Setup.withdrawCurrencySymbol} ${totalMoney!.toStringAsFixed(2)}",
                              fontSize: 27,
                            ...
                            TextWithTap(
                              "${Setup.withdrawCurrencySymbol} ${minQuantityToWithdraw!.toStringAsFixed(2)}",
                              fontSize: 27,
                              fontWeight: FontWeight.w900,
