...
import '../home/location/location_screen.dart';
import '../home/location/location_settings_screen.dart';
              ...
              if (snapshot.hasData) {
                if (widget.currentUser!.getUid == null) {
                  ...
                  return CompleteProfileScreen(
                    ...
                    currentStep: CompleteProfileScreen.currentStepFullName,
                  );
                } else if (widget.currentUser!.getBirthday == null) {
                  return CompleteProfileScreen(
                    currentUser: widget.currentUser,
                    currentStep: CompleteProfileScreen.currentStepBirthday,
                  );
                }
                ...
                // }
                else if (QuickHelp.getPhotosCounter(widget.currentUser).length <
                    Setup.photoNeededToRegister) {
                  return CompleteProfileScreen(
                    currentUser: widget.currentUser,
                    currentStep: CompleteProfileScreen.currentStepPhotos,
                  );
                } else {
