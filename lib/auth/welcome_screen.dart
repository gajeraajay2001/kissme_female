    ...
    if (response.success) {
      ...
      if (QuickHelp.isWebPlatform()) {
        ...
        QuickHelp.goToNavigatorScreen(
            ...
            route: CompleteProfileScreen.route,
            finish: true);
      } else {
            ...
            Align(
              ...
              child: Column(
                children: [
                  ...
                  Visibility(
                    visible:
                        preferences.getBool(Constants.facebookLoginConfig)!,
                    child: ButtonWithSvg(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      height: 48,
                      marginLeft: 5,
